...
{if(c==1)
 { 
 var y=document.getElementById("haunt");

  y.src="images/fort.jpg";
  c=c+1;
  }
  else if(c==2)
  {
...
<div id="wrapper">
	...
	<img id="haunt" src="images/haunted.jpg" width="300" height="200" alt="" /><br><br><br>
...
<form method=post action="hauntupload.jsp">

<input type="submit" class="button" value="Post"/>
<%
try
{
rs=st.executeQuery("select * from haunt");
