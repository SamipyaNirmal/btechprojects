...
{if(c==1)
 { var a=document.getElementById("anc");
  ...
  a.src="images/charminar-hyderabad.jpg";
...
<div id="wrapper">
	...
	<div class="menu">
	<h3><b>Welcome <%out.print(usn);%></h3><b>

	<img id="anc" src="images/ancient.jpg" width="300" height="200" alt="" /><br><br><br>
...
<form method=post action="ancupload.jsp">

<input type="submit" class="button" value="Post"/>
<%
try
{
rs=st.executeQuery("select * from anci");
