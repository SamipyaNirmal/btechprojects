...
<div id="wrapper">
	...
	<img id="beach" src="images/beach.jpg" width="300" height="200" alt="" /><br><br><br>
...
<form method=post action="beachupload.jsp">

<input type="submit" class="button" value="Post"/>
<%
try
{
rs=st.executeQuery("select * from beach");
