...
{if(c==1)
 { 
 var p=document.getElementById("pil");

  p.src="images/kedarnath.jpg";
...
<div id="wrapper">
	<div id="header-wrapper">
		<div id="header" class="container">
			<div id="logo">
				<h1>Travellers Adda</h1>
			<h3>Welcome <% out.print(usn);%></h3>
			</div>
	...
	<div class="menu">
	<h3><b>Welcome <%out.print(usn);%></b></h3>
	<img id="pil" src="images/2.jpg" width="300" height="200" alt="" /><br><br><br>
...
<form method=post action="pilupload.jsp">

<input type="submit" class="button" value="Post"/>
<%
try
{
rs=st.executeQuery("select * from pil");
